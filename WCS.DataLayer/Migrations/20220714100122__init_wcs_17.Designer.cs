...
namespace WCS.DataLayer.Migrations
{
    ...
    [Migration("20220714100122__init_wcs_17")]
    partial class _init_wcs_17
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WCS.ClassDomain.Domains.OrderCustomer", b =>
                {
                    b.Property<int>("OrderCustomer_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OrderCustomer_ID"), 1L, 1);

                    b.Property<string>("OrderCustomer_FirstName")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("OrderCustomer_LastName")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("OrderCustomer_Mobile")
                        .IsRequired()
                        .HasMaxLength(11)
                        .HasColumnType("nvarchar(11)");

                    b.HasKey("OrderCustomer_ID");

                    b.ToTable("WCS_OrderCustomer", (string)null);
                });

            modelBuilder.Entity("WCS.ClassDomain.Domains.OrderProducts", b =>
                {
                    b.Property<int>("OrderProducts_ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OrderProducts_ID"), 1L, 1);

                    b.Property<int>("OrderProducts_Count")
                        .HasColumnType("int");

                    b.Property<DateTime>("OrderProducts_DateRegister")
                        .HasColumnType("datetime2");

                    b.Property<string>("OrderProducts_Desc")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<int>("OrderProducts_OrderCustomerID")
                        .HasColumnType("int");

                    b.Property<long>("OrderProducts_Price")
                        .HasColumnType("bigint");

                    b.Property<int>("OrderProducts_ProductID")
                        .HasColumnType("int");

                    b.Property<string>("OrderProducts_ResultComment")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.HasKey("OrderProducts_ID");

                    b.ToTable("WCS_OrderProducts", (string)null);
                });
